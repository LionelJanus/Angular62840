...
import { Student } from '../../pages/students/models/student.model'; // Asegúrate de que este modelo esté definido
import { StudentsService } from '../../../../core/services/students.service'; // Servicio compartido
